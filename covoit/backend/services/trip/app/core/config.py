...
class Settings(BaseSettings):
    ...
    DATABASE_URL: str = Field(
        default="postgresql://postgres:postgres@postgres-trip:5434/trip_db",
        description="URL de connexion PostgreSQL pour la base trip_db"
    )
    ...
    SECRET_KEY: str = Field(
        default="your-secret-key-trip-service-change-in-production",
    ...
    SERVICE_TITLE: str = "Trip Service"
    
    # Description du service pour la documentation Swagger
    SERVICE_DESCRIPTION: str = "Service de gestion des trajets - création, recherche, modification"
